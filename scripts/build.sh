...
for TEXT_LIST_GROUP in $TEXT_LIST_GROUPS; do
    ...
    #add to TLGS
    TLGS="$TLGS $TEXT_LIST_GROUP_SAFE"
...
LGS=""
for TEXT_LIST_GROUP in $TLGS; do
    #Add to LGS in "$TEXT_LIST_GROUP",
    LGS="$LGS, '$TEXT_LIST_GROUP'"
done
#Remove the first comma
LGS=$(echo $LGS | sed 's/^, //')
#Replace in the example
sed -i "s/§LISTS§/$LGS/g" $BUILDDIR/examples/php/prepend.php
