...
$HL_loadedLists = ['keywords', 'keywords_commands', 'ips', 'sql_admin', 'cgi_bin_catch_all', 'cgi_bin', 'wordpress_catch_all', 'unrealisitic', 'common_abused_files', 'common_leaks', 'common_files', 'common_folders', 'common_impersonation_folders', 'common_backdoors', 'well_known', 'common_backdoors_well_known', 'unsure', 'wordpress_plugins', 'wordpress_like', 'unsorted', 'placeholder'];
